<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <!-- <div>
            ...
            <x-text-input id="cin" cin="cin" type="text" class="mt-1 block w-full" :value="old('cin', $user->cin)" required autofocus autocomplete="cin" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Enregistrez') }}</x-primary-button>
